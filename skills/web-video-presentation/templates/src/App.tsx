...
import { useRenderTimings } from "./hooks/useRenderTimings";
...
export default function App() {
  ...
  const isLastStep =
    ...
    stepper.cursor.step === CHAPTERS[CHAPTERS.length - 1]!.narrations.length - 1;

  const { onAutoAdvance } = useRenderTimings({
    mode,
    autoStarted,
    chapterId: ch.id,
